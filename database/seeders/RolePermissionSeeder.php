    ...
    public function run(): void
    {
        ...
        Listing::updateOrCreate(
            ...
            [
                ...
                'description' => 'Kos putri nyaman dengan lingkungan asri.',
                'city' => 'Padang',
                'district' => 'Padang Timur',
                'price' => 600000,
                'facilities' => ['WiFi', 'Kamar Mandi Dalam', 'Lemari'],
                'status' => 'Pending',
                'is_premium' => false,
                'owner_id' => $ahmad->id,
            ]
        ...
        Listing::updateOrCreate(
            ...
            [
                ...
                'description' => 'Kos exclusive dengan fasilitas lengkap dan parkir luas.',
                'city' => 'Padang',
        ...
        Listing::updateOrCreate(
            ...
            [
                ...
                'description' => 'Kos khusus mahasiswa dengan harga terjangkau.',
                'city' => 'Padang',
                'district' => 'Nanggalo',
                'price' => 450000,
                'facilities' => ['Kasur', 'Meja Belajar'],
                'status' => 'Pending',
                'is_premium' => false,
                'owner_id' => $ahmad->id,
            ]
        ...
        Listing::updateOrCreate(
            ...
            [
                'address' => 'Jl. Gajah Mada, Padang',
                'description' => 'Kos premium dengan keamanan 24 jam.',
                'city' => 'Padang',
                'district' => 'Nanggalo',
                'price' => 750000,
                'facilities' => ['AC', 'WiFi', 'Laundry', 'Security'],
                'status' => 'Approved',
                'is_premium' => true,
                'owner_id' => $ahmad->id,
            ]
